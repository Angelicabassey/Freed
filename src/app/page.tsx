    ...
    <main className="w-full font-sans">
      ...
      <div className="flex justify-center items-center py-16">
        ...
        <div className=" top-10 right-40 relative ">
          <Image src="/iPad Pro.png" alt={"img"} width={"500"} height={"500"} className="" />
        </div>
      </div>
      ...
      <div className="flex flex-row justify-center px-20">
        <div className=" left-10- relative">
          ...
          <div className="flex gap-6 my-24">
            <button className="bg-purple-900 py-1 px-4 text-white rounded-lg">Sign Up</button>
            <button className="text-purple-900  py-1 px-4 rounded-lg flex  gap-4 items-center"> Learn More <Image src="/arrow-side.png" alt={"img"} width={"20"} height={"20"} className="" /> </button>
          </div>
        </div>
      ...
      <div className="flex justify-center ">
        <div className="border border-purple-900 p-10">
          ...
          <div className="flex gap-6 my-6">
            ...
            <button className="text-purple-900  border border-purple-900 py-2 px-2 rounded-lg flex  gap-2 items-center"> Learn More <Image src="/arrow-side.png" alt={"img"} width={"20"} height={"20"} className="" /> </button>
          </div>
        </div>
